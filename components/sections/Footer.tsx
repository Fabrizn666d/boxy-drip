...
export function Footer() {
  ...
  return <footer id="footer" className="site-footer footer-reference">
    ...
    <div className="footer-bottom-wrap"><div className="footer-bottom"><span>© 2026 Boxy Drip.<span className="footer-copyright-extra"> Todos los derechos reservados.</span></span><div className="footer-signoff"><span>Ica · Perú</span><strong>DRIP TODAY. MOVE DIFFERENT.</strong></div><a className="footer-mobile-claims" href={`${whatsapp}?text=${encodeURIComponent("Hola Boxy Drip, quisiera solicitar acceso al libro de reclamaciones.")}`} target="_blank" rel="noreferrer"><FileText aria-hidden="true" />Libro de Reclamaciones</a><a className="footer-credit" href="https://wilostudio.site" target="_blank" rel="noopener noreferrer" aria-label="Wilo Studio, visitar sitio en una nueva pestaña"><span className="footer-credit-desktop">Desarrollado por</span><span className="footer-credit-mobile">Hecho por</span><span><b>WILO</b> STUDIO</span><ExternalLink aria-hidden="true" /></a></div></div>
  </footer>;
}
